package com.fabiorachid.colormyviews
...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeColored(view: View) {
        when(view.id) {
            ...
            R.id.yellow_button -> box_four_text.setBackgroundColor(ContextCompat.getColor(this, R.color.my_yellow))
            R.id.green_button -> box_five_text.setBackgroundColor(ContextCompat.getColor(this, R.color.my_green))
